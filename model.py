...
def load_model(input_shape):
    ...
    print("conv 1 = " + str(conv_1._shape))
    ...
    print("conv 3 = " + str(conv_3._shape))
    ...
    print("conv 5 = " + str(conv_5._shape))
    ...
    print("conv 8 = " + str(conv_8._shape))
    ...
    print("conv10 1 = " + str(conv_10._shape))
    ...
    print("conv12  = " + str(conv_12._shape))
    ...
    print("layer 1 = " + str(conv_1._shape))
